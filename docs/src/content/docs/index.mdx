---
title: tallow
description: An extensible, multi-model coding agent for your terminal. 30+ extensions, 34 themes, multi-agent teams, and lifecycle hooks. Compatible with Claude Code.
template: splash
head:
  - tag: title
