...
5. **Project .claude/agents/** — nearest ancestor with .claude/agents/
6. **Project .tallow/agents/** — nearest ancestor with .tallow/agents/
...
Hard limit on tool-use turns. When the subprocess reaches this many `tool_call_start`
