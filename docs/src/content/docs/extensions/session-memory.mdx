...
By default, the tool filters results to the current project
(based on the current working directory basename). Use the
`project` parameter to override that scope and search a
