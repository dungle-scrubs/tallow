...
Shutting down a team — whether via `team_shutdown` or session end —
...
Inside the dashboard, <kbd>Esc</kbd> closes the dashboard and returns
you to chat. It does **not** kill teammates or archive teams.
