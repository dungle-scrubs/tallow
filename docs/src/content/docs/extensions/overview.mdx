...
|----------|-------|--------------|
| **Tools** | 18 | bash, edit, read, write, cd, web_fetch, web_search, subagent, teams, tasks, agent-commands, ask-user-question, background-task, output-styles, theme-selector, MCP adapter, session-memory |
