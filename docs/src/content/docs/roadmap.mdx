...
<div class="roadmap-item" data-status="planned">
  <div class="roadmap-header">
    <h3>Teams Live Dashboard Widget</h3>
...
<div class="roadmap-item" data-status="planned">
  <div class="roadmap-header">
    ...
    <span class="roadmap-badge" data-complexity="high">High complexity</span>
    <span class="roadmap-badge" data-status="in-progress">Nearly complete</span>
  </div>
  <div class="roadmap-description">
...
<ul class="roadmap-checklist">
  <li data-done><strong>Commands.</strong> .tallow/commands/ project-local and ~/.tallow/commands/ global, via commands-folder extension. Also scans commands/ in local paths listed in settings.json packages.</li>
...
`Ctrl+S` stashes the current input, `Ctrl+U` restores it. Stack
semantics with last-in-first-out. In-memory only. Not yet implemented.

  </div>
  <div class="roadmap-meta">
    <span class="roadmap-meta-item"><strong>Extension:</strong> stash-prompt (planned)</span>
    <span class="roadmap-meta-item"><strong>Keybinding:</strong> Ctrl+S / Ctrl+U</span>
  </div>
</div>
