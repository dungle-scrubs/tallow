...
48 extensions, 34 themes, 8 slash commands, and 9 specialized agents.
Install only what you need — the interactive installer lets you pick.

## Features

- **48 bundled extensions** — enhanced tools, hooks, tasks, teams, LSP, themes, context usage, and more
